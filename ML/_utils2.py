...
# 输入文件个数: 1, + label   train test     valid   return x, y  仅包括数据
# 输入文件个数: 2, concat + label   train test     valid
...
if __name__ == "__main__":
    endpoint_name = "cyp2c9"
    des_name = "RDKIT"
    pathTr = "datasets/Dataset_in_MOLD2/cyp2c9_train_MOLD2.csv"
    pathTe = "datasets/Dataset_in_MOLD2/cyp2c9_test_MOLD2.csv"
    pathTr1 = "datasets/Dataset_in_RDKIT/cyp2c9_train_RDKIT.csv"
    pathTe1 = "datasets/Dataset_in_RDKIT/cyp2c9_test_RDKIT.csv"
    d = DataProcessing(endpoint_name, des_name)
    trainX, trainY = d(pathTr)
    testX, testY = d(pathTe)

    # boruta_py(rf_model, trX, trY, teX, teY)
    # genetic_method(rf_model, trX, trY, teX, teY)
