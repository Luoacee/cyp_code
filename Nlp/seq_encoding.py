...
if __name__ == "__main__":
    ...
    file_read_ = pd.read_csv("split/cyp2c9_valid_MACCS.csv")
    p = partial(molecular_initiation, atom_list=ATOM, smiles_shuffle=True, length_limit=145)
